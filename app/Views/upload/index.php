    ...
    <div class="upload-container">
        ...
        <div class="main-content">
            <div class="upload-section">
                ...
                <?php if ($message): ?>
                    <div class="message <?= (strpos($message, 'thành công') !== false) ? 'message-success' : 'message-error' ?>">
                        <i class="fas <?= (strpos($message, 'thành công') !== false) ? 'fa-check-circle' : 'fa-exclamation-circle' ?>"></i>
                        <?= $message ?>
                    </div>
                <?php endif; ?>
                ...
                <?php if ($storageExceeded || $storageNearlyFull): ?>
                    <div class="storage-exceeded">
                        ...
                        <?php else: ?>
                            ...
                            <p>Bạn đã dùng <?= number_format($usedStorage / 1024 / 1024, 2) ?>MB / <?= number_format($storageLimit / 1024 / 1024, 0) ?>MB (còn <?= number_format(($storageLimit - $usedStorage) / 1024, 0) ?>KB trống). Xóa bớt file hoặc nâng cấp để có thêm dung lượng.</p>
                        <?php endif; ?>
