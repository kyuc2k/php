...
<head>
    ...
    <style>
        ...
        .auth-left h1 { font-size: 2.5rem; font-weight: 700; margin-bottom: 20px; }
        ...
        .divider span { background: white; padding: 0 15px; position: relative; color: #666; font-size: 0.9rem; }
        .auth-footer { text-align: center; margin-top: 25px; color: #666; font-size: 0.9rem; }
...
<body>
    <div class="auth-container">
        <div class="auth-left">
            <h1>Tạo tài khoản</h1>
            <p>Bắt đầu sử dụng hệ thống quản lý PDF thông minh</p>
            <ul class="features">
                <li><i class="fas fa-check-circle"></i> Miễn phí sử dụng</li>
                <li><i class="fas fa-infinity"></i> Không giới hạn số file</li>
                <li><i class="fas fa-lock"></i> Bảo mật dữ liệu</li>
                <li><i class="fas fa-cloud"></i> Truy cập mọi nơi</li>
            </ul>
        </div>
        <div class="auth-right">
            <h2 class="auth-title">Đăng ký</h2>
            <p class="auth-subtitle">Đã có tài khoản? <a href="login.php">Đăng nhập</a></p>

            <?php if ($message): ?>
                <div class="message <?= strpos($message, 'already') !== false || strpos($message, 'not match') !== false ? 'message-error' : 'message-success' ?>">
            ...
            <form method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="password" id="password" name="password" placeholder="Tạo mật khẩu (ít nhất 6 ký tự)" minlength="6" required>
                </div>
                <div class="form-group">
                    <label for="repassword">Xác nhận mật khẩu</label>
                    <input type="password" id="repassword" name="repassword" placeholder="Nhập lại mật khẩu" required>
                </div>
                <button type="submit" name="register" class="btn btn-primary">Tạo tài khoản</button>
